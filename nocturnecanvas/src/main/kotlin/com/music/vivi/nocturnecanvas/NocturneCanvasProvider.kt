package com.music.vivi.nocturnecanvas
...
@Serializable
data class NocturneCanvasManifest(
    val items: List<NocturneCanvasItem> = emptyList()
)

@Serializable
data class NocturneCanvasItem(
    val song: String,
    val artist: String,
    val url: String,
    val album: String = "",
...
object NocturneCanvasProvider {
    ...
    private data class CacheEntry(
        val value: NocturneCanvasManifest?,
    ...
    private suspend fun fetchManifest(): NocturneCanvasManifest? {
        ...
        return try {
            val manifest: NocturneCanvasManifest = client.get(BASE_URL).body()
