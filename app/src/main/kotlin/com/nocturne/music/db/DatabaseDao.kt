...
import com.nocturne.music.constants.AlbumSortType
import com.nocturne.music.constants.ArtistSongSortType
import com.nocturne.music.constants.ArtistSortType
import com.nocturne.music.constants.PlaylistSortType
import com.nocturne.music.constants.SongSortType
import com.nocturne.music.db.entities.Album
import com.nocturne.music.db.entities.AlbumArtistMap
import com.nocturne.music.db.entities.AlbumEntity
import com.nocturne.music.db.entities.AlbumWithSongs
import com.nocturne.music.db.entities.Artist
import com.nocturne.music.db.entities.ArtistEntity
import com.nocturne.music.db.entities.Event
import com.nocturne.music.db.entities.EventWithSong
import com.nocturne.music.db.entities.FormatEntity
import com.nocturne.music.db.entities.LyricsEntity
import com.nocturne.music.db.entities.PlayCountEntity
import com.nocturne.music.db.entities.Playlist
import com.nocturne.music.db.entities.PlaylistEntity
import com.nocturne.music.db.entities.PlaylistSong
import com.nocturne.music.db.entities.PlaylistSongMap
import com.nocturne.music.db.entities.RecognitionHistory
import com.nocturne.music.db.entities.RelatedSongMap
import com.nocturne.music.db.entities.SearchHistory
import com.nocturne.music.db.entities.SetVideoIdEntity
import com.nocturne.music.db.entities.Song
import com.nocturne.music.db.entities.SongAlbumMap
import com.nocturne.music.db.entities.SongArtistMap
import com.nocturne.music.db.entities.SongEntity
import com.nocturne.music.db.entities.SongWithStats
import com.nocturne.music.extensions.reversed
import com.nocturne.music.extensions.toSQLiteQuery
...
interface DatabaseDao {
    ...
    fun artists(sortType: ArtistSortType, descending: Boolean, sourceFilter: com.nocturne.music.constants.ArtistSourceFilter = com.nocturne.music.constants.ArtistSourceFilter.ALL) =
        when (sortType) {
            ...
            artists
                .filter {
                    when (sourceFilter) {
                        com.nocturne.music.constants.ArtistSourceFilter.ALL -> it.artist.isYouTubeArtist || it.artist.isLocal
                        com.nocturne.music.constants.ArtistSourceFilter.LOCAL -> it.artist.isLocal
                        com.nocturne.music.constants.ArtistSourceFilter.YOUTUBE -> it.artist.isYouTubeArtist
                    }
                }
                .reversed(descending)
        }

    fun artistsBookmarked(sortType: ArtistSortType, descending: Boolean, sourceFilter: com.nocturne.music.constants.ArtistSourceFilter = com.nocturne.music.constants.ArtistSourceFilter.ALL) =
        when (sortType) {
