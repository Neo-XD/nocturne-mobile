...
import com.nocturne.music.constants.LastFMSessionKey
import com.nocturne.music.constants.LastFMUseNowPlaying
import com.nocturne.music.constants.LastFMUseSendLikes
import com.nocturne.music.constants.LastFMUsernameKey
                                    ...
                                    .onFailure { exception ->
                                        coroutineScope.launch(Dispatchers.Main) {
                                            ...
                                            loginError = when (exception) {
                                                is com.nocturne.lastfm.LastFM.LastFmException -> {
                                                    when (exception.code) {
