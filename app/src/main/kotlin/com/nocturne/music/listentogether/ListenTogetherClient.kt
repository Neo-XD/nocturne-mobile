...
package com.nocturne.music.listentogether
...
import com.nocturne.music.constants.ListenTogetherAutoApprovalKey
import com.nocturne.music.constants.ListenTogetherIsHostKey
import com.nocturne.music.constants.ListenTogetherRoomCodeKey
import com.nocturne.music.constants.ListenTogetherServerUrlKey
import com.nocturne.music.constants.ListenTogetherSessionTimestampKey
import com.nocturne.music.constants.ListenTogetherSessionTokenKey
import com.nocturne.music.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.nocturne.music.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.nocturne.music.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.nocturne.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.nocturne.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.nocturne.music.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.nocturne.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
