...
package com.nocturne.music.nocturne.updater
...
import com.nocturne.music.nocturne.updater.downloadmanager.UpdateDownloadWorker
import com.nocturne.music.nocturne.updater.downloadmanager.DownloadNotificationManager
...
import com.nocturne.music.ui.component.ChangelogItem
import com.nocturne.music.ui.component.leadingItemShape
import com.nocturne.music.ui.component.middleItemShape
import com.nocturne.music.ui.component.endItemShape
import com.nocturne.music.ui.component.detachedItemShape
import com.nocturne.music.ui.component.AnimatedActionButton
import com.nocturne.music.ui.component.ExpressiveIconButton
import com.nocturne.music.ui.component.ErrorSnackbar
import com.nocturne.music.ui.component.UpdaterBlobCluster
                                ...
                                AnimatedActionButton(
                                    ...
                                    onClick = {
                                        if (isDownloadComplete) {
                                            ...
                                            val urlToDownload = currentStatus.apkUrl ?: "https://github.com/Neo-XD/nocturne-mobile/releases/download/${currentStatus.version}/vivi.apk"
                            ...
                            when (currentStatus) {
                                is ViviUpdateStatus.Checking -> {
                                    Column(
                                        ...
                                        Text(
                                            text = stringResource(com.nocturne.music.R.string.checking_for_updates),
                                    ...
                                    Column(
                                        ...
                                        currentStatus.changelog.forEach { section ->
                                            ...
                                            section.items.forEachIndexed { index, item ->
                                                val shape = when {
                                                    section.items.size == 1 -> com.nocturne.music.ui.component.detachedItemShape()
                                                    index == 0 -> com.nocturne.music.ui.component.leadingItemShape()
                                                    index == section.items.size - 1 -> com.nocturne.music.ui.component.endItemShape()
                                                    else -> com.nocturne.music.ui.component.middleItemShape()
                                                }
                                                com.nocturne.music.ui.component.ChangelogItem(
                                                    text = item,
                                                    shape = shape,
...
suspend fun checkForUpdate(
    ...
    withContext(Dispatchers.IO) {
        try {
            val url = URL("https://api.github.com/repos/Neo-XD/nocturne-mobile/releases")
            ...
            if (betaEnabled) {
                try {
                    val nightlyUrl = URL("https://api.github.com/repos/Neo-XD/nocturne-mobile/actions/workflows/nightly.yml/runs?status=success&per_page=100")
            ...
            if (isNightlyUpdate && nightlyRunObject != null) {
                ...
                val apkDownloadUrl = "https://nightly.link/Neo-XD/nocturne-mobile/workflows/nightly.yml/main/vivi-music-gms-nightly.zip"
            ...
            if (targetRelease != null) {
                ...
                if (shouldShow) {
                    ...
                    try {
                        val changelogUrl =
                            URL("https://github.com/Neo-XD/nocturne-mobile/releases/download/$tagWithPrefix/changelog.json")
